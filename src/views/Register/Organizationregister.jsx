...
class RegisterPage extends React.Component {
  ...
  registerFunc() {
    let th = this;
    if (this.state.companyName === "" || this.state.companyName === "error") {
      this.setState({ companyNameState: "error" });
    }
    else if (this.state.registerEmail === "" || this.state.registerEmail === "error") {
      this.setState({ registerEmailState: "error" });
    }
    else if (this.state.registerPassword === "" || this.state.registerPassword === "error") {
      ...
      let data = { "email": th.state.registerEmail, "password": encodedpassPassword, "userType": 'organization', companyName: th.state.companyName };
              ...
              <Card login className={classes[this.state.cardAnimaton]} >
                ...
                <CardBody>
                  ...
                  <div className='emailbody'>
                    Please check your email to verify and activate your Merritos account.
              </div>
                  <br />
