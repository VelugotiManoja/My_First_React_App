...
class Dashboard extends React.Component {
  ...
  addskills=(goal)=>{
    ...
    if($.trim($('.skillinput').val())==''){
      $('.skillinput').after('<span style="color:red;font-size:12px;display:block">Field should not be empaty</span>');
      return false
    }
...
<Container className="profile-goal" id="profile-goal">
  <div className="profile-goal-row">
    ...
    <Col xs="auto" className="profile-goal-arrow">
      <img src={this.state.linegoal} width="45px" />
    </Col>
    <Col xs="5" sm="3">
...
>
  <BottomNavigationAction label="Classes" icon={<i className="material-icons">desktop_windows</i>} onClick={(e) => this.mobileTabs(e, '#basic-info')} />
